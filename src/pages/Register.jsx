...
const Register = ({ setUserData }) => {
  ...
  return (
    ...
    <div className="p-10 relative z-100 w-[80%] justify-self-end min-h-screen flex flex-col justify-center items-center">
      <h1 className="text-3xl font-bold text-amber-50 mb-6">Register</h1>
      <form
      ...
      >
        <input
          ...
          required
          className="p-2 rounded bg-[#1e2749ff]/40 focus:outline-none focus:ring-2 focus:ring-yellow-300"
        />
        <input
          type="text"
          name="lastName"
