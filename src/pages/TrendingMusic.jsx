        ...
        <section className="relative z-100 p-10 w-[80%] justify-self-end">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div className="flex items-center space-x-6">
              ...
              />
              <div>
                <h1 className="text-3xl font-bold mb-2 text-[#8c61f9]">The History</h1>
            ...
            <div className="mt-6 md:mt-0">
              <button className="px-6 py-3 bg-pink-800 hover:bg-pink-600 text-white rounded-full flex items-center space-x-2 shadow-md font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 flex flex-col items-center text-center shadow-md hover:bg-white/20 transition-all duration-200">
              ...
              <p className="text-2xl font-bold mt-1">{stats.dailyListening} h</p>
            </div>
          ...
          <div className="flex justify-center space-x-6 mb-8 text-gray-200 font-semibold">
            {["All", "Year", "Last six months", "Last four weeks"].map((filter) => (
              <button
                key={filter}
                onClick={() => handleFilter(filter)}
                className={`px-3 py-1 rounded-md transition ${activeFilter === filter
